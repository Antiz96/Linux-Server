...
sudo apt install vim man bash-completion openssh-server dnsutils traceroute rsync diffutils firewalld plocate htop curl openssl socat chrony wget logrotate fail2ban python3-passlib fastfetch acl
